...
def test_guest_can_add_product_to_basket(browser):
    ...
    basket_price = page.get_basket_product_price()
    page.product_must_match(product_name, basket_product_name)
...
def test_guest_cant_see_success_message_after_adding_product_to_basket(browser):
    ...
    delta = end - begin
    print(f"delta datetime: %s" % delta)
...
def test_message_disappeared_after_adding_product_to_basket(browser):
    ...
    page.solve_quiz_and_get_code()
    begin = datetime.now()
    page.message_should_not_dissapired()
    end = datetime.now()
    delta = end - begin
    print(f"delta datetime: %s" % delta)
